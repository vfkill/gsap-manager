    ...
    markers: false
            ...
            $anim_ref = [
                ...
                'Imagens' => [
                    ...
                    [ 'class' => 'gsap-img-scroll-scale', 'desc' => 'Imagem mantém o tamanho configurado e escala UP até preencher o container conforme o scroll (sem pin). Origin é auto-detectado pela borda mais próxima da imagem (encostada à direita cresce pra esquerda, no topo cresce pra baixo, centralizada cresce pra todos os lados). Container é detectado automaticamente subindo no DOM até achar um ancestor 1.2× maior.', 'req' => 'ScrollTrigger', 'ex' => '<div style="height:600px;display:flex;justify-content:flex-end;align-items:flex-start"><img class="gsap-img-scroll-scale" src="foto.jpg" style="width:30%"></div>' ],
                    [ 'class' => 'gsap-img-scroll-scale-pin', 'desc' => 'Igual ao <code>gsap-img-scroll-scale</code>, mas pina o container no topo do viewport até a imagem terminar de preencher (estilo dsgngroup.it). <code>data-gsap-end="+=100%"</code> distância de scroll · <code>data-gsap-scrub="0.5"</code> · <code>data-gsap-from</code> / <code>data-gsap-to</code> override de escala · <code>data-gsap-origin="top right"</code> origin manual · <code>data-gsap-container=".meu-seletor"</code> container manual.', 'req' => 'ScrollTrigger', 'ex' => '<div style="height:600px;display:flex;justify-content:flex-end;align-items:flex-start"><img class="gsap-img-scroll-scale-pin" src="foto.jpg" style="width:30%"></div>' ],
                ],
                'Elementos' => [
