    ...
    markers: false
            ...
            $anim_ref = [
                ...
                'Imagens' => [
                    ...
                    [ 'class' => 'gsap-img-scroll-scale', 'desc' => 'Imagem mantém o tamanho configurado e escala UP até preencher o container conforme o scroll (sem pin). <strong>Recomendado:</strong> marque o container com a classe <code>gsap-scale-container</code> pra detecção 100% confiável do origin. Caso contrário, faz fallback automático.', 'req' => 'ScrollTrigger', 'ex' => '<div class="gsap-scale-container" style="height:600px;display:flex;justify-content:flex-end;align-items:flex-start"><img class="gsap-img-scroll-scale" src="foto.jpg" style="width:30%"></div>' ],
                    [ 'class' => 'gsap-img-scroll-scale-pin', 'desc' => 'Igual ao <code>gsap-img-scroll-scale</code>, mas pina o container no topo do viewport até a imagem terminar de preencher (estilo dsgngroup.it). Atributos: <code>data-gsap-end="+=100%"</code> distância de scroll · <code>data-gsap-scrub="true"</code> (default, sem lag) · <code>data-gsap-from</code>/<code>data-gsap-to</code> override de escala · <code>data-gsap-origin="top right"</code> origin manual · <code>data-gsap-container=".meu-seletor"</code> container manual · <code>data-gsap-debug="1"</code> loga o container detectado no console.', 'req' => 'ScrollTrigger', 'ex' => '<div class="gsap-scale-container" style="height:600px;display:flex;justify-content:flex-end;align-items:flex-start"><img class="gsap-img-scroll-scale-pin" src="foto.jpg" style="width:30%"></div>' ],
                ],
                'Elementos' => [
